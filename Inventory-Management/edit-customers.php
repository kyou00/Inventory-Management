...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `customers` SET `customer_name`='$name',`email`='$email',`address`='$address',`city`='$city',`phone`='$phone' WHERE id=$id;";
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Edited a customer', '$date')";
    $result = mysqli_multi_query($conn, $sql);

    if($result){
        header("Location: customers.php?msg=Data Updated Successfully");
    }
    else{
...
<html>
    ...
    <div class="home_content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <a href="customers.php"><div class="close-btn" onclick="closeForm()">&times;</div></a>
            <div class="form">
                <h2>Edit Customer</h2>
                <div class="form-element">
                    <input type="text" class="form-control" name="name" placeholder="Enter name" value="<?php echo $row['customer_name'] ?>">
                </div>
                <div class="form-element">
                ...
                <div class="form-element">
                    <input type="text" class="form-control" name="phone" placeholder="Enter number" value="<?php echo $row['phone'] ?>">
                </div>
                <div class="form-element">
