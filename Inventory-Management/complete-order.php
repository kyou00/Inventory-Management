                ...
                <div class="table">
                    <div class="table_header">
                        ...
                        <input class="input2" type="text" placeholder="Orders" id="live_search"/>
                            ...
                            <a href="orders.php"><button class="add_new" id="show-login">View Orders</button></a>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                include "db_conn.php";
                                    ...
                                    $sql = "SELECT ord.date,ord.id,inv.product_name,ord.total_cost,ord.total_quantity,bran.branch_name,cus.customer_name,ord.status FROM done_orders ord, inventory inv, customers cus, branches bran WHERE ord.itemid = inv.id && cus.id = ord.customerid && bran.id ORDER BY ord.date DESC";
                                    $result = mysqli_query($conn,$sql);
                                    function getRole($n){
                                        // Is number less than 11
                                        if($n == 'User') return "none";
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#live_search").keyup(function(){
                ...
                if(input != ""){
                    $.ajax({
                        url:"livesearch-done-orders.php",
                        method:"POST",
                        data:{input:input},
