...
if(isset($_POST['input'])){
    ...
    $query = "SELECT inv.*,cat.category_name,sup.supplier_name FROM inventory inv, category cat,suppliers sup WHERE `status` = 'enable' && inv.categoryid = cat.id && inv.supplierid = sup.id && inv.product_name LIKE '{$input}%' OR `status` = 'enable' && inv.categoryid = cat.id && inv.supplierid = sup.id && inv.product_code LIKE '{$input}%' OR `status` = 'enable' && inv.categoryid = cat.id && inv.supplierid = sup.id && cat.category_name LIKE '{$input}%'";
