            ...
            <div class="container">
                <div class="table">
                    <div class="table_header">
                        <p>Sales Details</p>
                        <div>
                        <input class="input2" type="text" placeholder="Sales" id="live_search"/>
                        <!-- <a href="orders.php">
                            <button class="add_new" id="show-login">View Orders</button>
                        </a> -->
                    ...
                    <div class="table_section" id="table_section"style="height: 850px;">
                        <table>
                            ...
                            <tbody>
                                <?php
                                include "db_conn.php";
                                    $sql = "SELECT inv.product_name,inv.image,inv.product_code,cat.category_name,sal.total_sales,sal.sales_count FROM sales sal,inventory inv,category cat WHERE inv.categoryid = cat.id && sal.itemid = inv.id";
