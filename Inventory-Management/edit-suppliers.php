...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `suppliers` SET `supplier_name`='$name',`email`='$email',`address`='$address',`city`='$city',`phone`='$phone' WHERE id=$id;";
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Edited a supplier', '$date')";
...
<html>
    ...
    <div class="home_content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <a href="suppliers.php"><div class="close-btn" onclick="closeForm()">&times;</div></a>
            <div class="form">
                <h2>Edit Product</h2>
                <div class="form-element">
                    <input type="text" class="form-control" name="name" placeholder="Enter name" value="<?php echo $row['supplier_name'] ?>">
                </div>
                <div class="form-element">
