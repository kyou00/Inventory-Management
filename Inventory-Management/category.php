...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `category`(`id`, `category_name`) VALUES (NULL,'$name');";
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Added new category - $name','$date')";

    $result = mysqli_multi_query($conn,$sql);

    if($result){
        header("Location: category.php?msg=New record created successfully");
    }
    else{
            ...
            <div class="container">
                <div class="table">
                    <div class="table_header">
                        ...
                        <div>
                        <input class="input2" type="text" placeholder="Category" id="live_search"/>
                    ...
                    <div class="table_section" id="table_section" style="height: 850px;">
                        <table>
                            ...
                            <tbody>
                                <?php
                                include "db_conn.php";
                                    $sql = "SELECT cat.id,cat.category_name , SUM(inv.quantity) FROM inventory inv, category cat WHERE cat.id = inv.categoryid GROUP BY cat.category_name";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-category.php?id=<?php echo $row['id'] ?>" ><i class='bx bxs-edit' style="font-size: 25px"></i></a>
                                                <!-- <a href="delete-category.php?id=<?php echo $row['id'] ?>" style="display:<?=$validation?>"><i class='bx bx-trash'></i></a> -->
                                            </td>
                                        </tr>
                                        <?php
                                    }
