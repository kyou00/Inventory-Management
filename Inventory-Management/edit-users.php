...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `users` SET `name`='$name',`email`='$email',`role`='$role',`number`='$number',`username`='$username' WHERE id=$id;";
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Edited a user', '$date')";
...
<html>
    ...
    <div class="home_content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <a href="users.php"><div class="close-btn" onclick="closeForm()">&times;</div></a>
            <div class="form">
                <h2>Edit User</h2>
                ...
                <div class="form-element">
                    <input type="text" class="form-control" name="role" placeholder="Enter role" value="<?php echo $row['role'] ?>">
                </div>
                <div class="form-element">
                    <input type="text" class="form-control" name="number" placeholder="Enter number" value="<?php echo $row['number'] ?>">
                </div>
                <div class="form-element">
