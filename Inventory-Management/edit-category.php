...
if(isset($_POST['submit'])) {
    ...
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Edited a category', '$date')";
...
<html>
    ...
    <div class="home_content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <a href="category.php"><div class="close-btn" onclick="closeForm()">&times;</div></a>
            <div class="form">
                <h2>Edit Category</h2>
                <div class="form-element">
                    <input type="text" class="form-control" name="name" placeholder="Enter name" value="<?php echo $row['category_name'] ?>">
                </div>
                <div class="form-element">
