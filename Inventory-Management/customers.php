...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `customers`(`id`, `customer_name`, `email`, `address`, `city`, `phone`) VALUES (NULL,'$name','$email','$address','$city','$phone');";
    $sql .= "INSERT INTO `user_activity`(`id`, `user`, `activity`, `date`) VALUES (NULL,'{$_SESSION['username']}','Added new customer - $name','$date')";
            ...
            <div class="container">
                <div class="table">
                    <div class="table_header">
                        ...
                        <div>
                        <input class="input2" type="text" placeholder="Customer" id="live_search"/>
                                ...
                                include "db_conn.php";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-customers.php?id=<?php echo $row['id'] ?>" ><i class='bx bxs-edit' style="font-size: 25px"></i></a>
                                                <!-- <a href="invoice.php?id=<?php echo $row['id'] ?>" ><i class='bx bx-dollar-circle'></i></a> -->
                                                <a href="delete-customers.php?id=<?php echo $row['id'] ?>" style="display:<?=$validation?>"><i class='bx bx-trash' style="font-size: 25px"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
    ...
    <div class="popup" id="myForm">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form">
                ...
                <div class="form-element">
                    <input type="text" class="form-control" name="phone" minlength="11" maxlength="11" placeholder="Enter number">
                </div>
                <div class="form-element">
